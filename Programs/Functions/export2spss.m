function fid = export2spss(names, data, titl)
...
% strings (e.g. names = {'participant', 'age', 'score'};. The function only
...
sizes = [12*ones(1,length(data)); ...
         6*ones(1,length(data))];
